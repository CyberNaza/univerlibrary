...
class Book(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.pdf and not self.first_page_image:
            try:
                ...
                if images:
                    ...
                    image_filename = f"{os.path.splitext(self.pdf.name)[0]}_first_page.png"
                    self.first_page_image.save(image_filename, image_file, save=False)
                    super().save(*args, **kwargs)
